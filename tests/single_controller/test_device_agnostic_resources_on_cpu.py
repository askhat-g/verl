...
or by assuming a bundle layout Ray does not guarantee. They run without a Ray cluster and
without an accelerator: the Ray state APIs and the active platform are stubbed out.
"""
